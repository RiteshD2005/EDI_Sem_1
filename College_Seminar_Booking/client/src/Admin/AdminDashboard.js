...
const AdminDashboard = () => {
  ...
  const quickActions = [
    { icon: "fa-file-pdf", label: "Generate Report", action: () => {setActiveView('report') } },
    { icon: "fa-user-plus", label: "Add Admin", action: () => { setActiveView('dashboard') } },
        ...
        <Row>
          ...
          <Col md={2} className="sidebar d-none d-md-block">
            <Nav className="flex-column">
              <Nav.Link className={ActiveView === 'dashboard' ? 'active' : ''} onClick={() => setActiveView('dashboard')}>
                <i className="fas fa-tachometer-alt me-2" ></i> Dashboard
              </Nav.Link>
              <Nav.Link className={ActiveView === 'addAdmin' ? 'active' : ''} onClick={() => setActiveView('addAdmin')}><i className="fas fa-users me-2"></i> Add Admin </Nav.Link>
              <Nav.Link className={ActiveView === 'report' ? 'active' : ''} onClick={() => setActiveView('report')}><i class="fa-solid fa-chart-pie me-2"></i> Report </Nav.Link>
